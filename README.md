...
| `resumeFromRunId` | string | no | Replay an earlier run in this session — its unchanged `agent()` calls return their recorded results instead of spawning; a changed call and everything downstream of it runs live |
